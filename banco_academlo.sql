...
--query 1
select clients.id as id_cliente, clients.first_name as nombre, clients.last_name as apellido, clients.email, accounts.account_no as cuenta, accounts.balance  
from accounts 
right join clients on clients.id = accounts.client_id ;
